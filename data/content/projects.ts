...
const projects = [
  {
    ...
    desc: "Chatbot for cal poly students to ask class related questions using machine learning techniques",
    // img: `${process.env.NEXT_PUBLIC_BASE_URL}static/projects/wasalt.jpg`,
    link: "https://github.com/dqawami/csc466-project2",
    img: "/images/projects/calpass.jpg",
    tags: ["Python", "MySQL", "SciKitLearn", "BeautifulSoup"]
  },
  {
    id: 1,
    title: "Tape Master VST",
    desc: "Custom Tape Machine Audio Plugin that utilizes Deep Learning to emulate a real tape machine",
    // img: `${process.env.NEXT_PUBLIC_BASE_URL}static/projects/etihaas.jpg`,
    link: "https://github.com/colewarner24/mypedalnet",
    tags: [
      "TensorFlow",
      "JUCE",
      "Python",
  ...
  {
    id: 2,
    title: "Music Page Application",
    desc: "Full Stack Music Profile Application using the Spotify API",
    // img: `${process.env.NEXT_PUBLIC_BASE_URL}static/projects/etihaas.jpg`,
    link: "https://github.com/colewarner24/mypedalnet",
    tags: [
      "React",
  ...
  },
  {
    ...
    desc: "Personal Project Website to showcase my skills and experience",
    // img: `${process.env.NEXT_PUBLIC_BASE_URL}static/projects/etihaas.jpg`,
    link: "https://github.com/colewarner24/myportfolio",
    tags: [
      "Next.js",
      "React",
      "Tailwind CSS",
